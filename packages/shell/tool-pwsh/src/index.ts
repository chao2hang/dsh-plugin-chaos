...
import { ESCALATION_TARGETS, approveEscalation, normalizeEscalationArgs } from '@deepseek-ai/dsh-sandbox'
...
export function apply(ctx: Context, config: Config = {}): void {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: PwshToolArgs, exec) {
      ...
      const approvedMode = sandboxPermissions !== undefined && justification !== undefined
        ? await approvePwshEscalation(sandboxPermissions, justification, exec, standingPolicy)
        : undefined
