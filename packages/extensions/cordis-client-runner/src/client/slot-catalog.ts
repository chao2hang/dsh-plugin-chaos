...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-interrupted, turn-max-tokens, turn-process, turn-tail, unknown, user, workflow-run',
    ...
    occupants: [
      ...
      'plugin-chaos-retry TurnInterruptedNodeView key \'turn-interrupted\'',
      'plugin-chaos-think-tags ThinkTagAssistantNodeView key \'assistant-step\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'plugin-chaos-at-file FilesDock id \'chaos-at-file\'',
      'plugin-chaos-retry RetryDock id \'chaos-retry\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'plugin-chaos-mobile AttachmentButton id \'chaos-mobile-attachment-picker\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'plugin-chaos-at-file FolderNavigator id \'chaos-at-file-navigation\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'plugin-chaos-models ModelCapabilities id \'chaos-model-capabilities\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-chat UsageReport id \'statistics\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'plugin-chaos-at-file AtFileSection id \'chaos-at-file\'',
      'plugin-chaos-restart RestartSection id \'chaos-system\'',
    ],
    replaceRisk: 'none',
