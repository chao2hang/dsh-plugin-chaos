...
describe('MobileOverlay', () => {
  ...
  it('shows the selected session title and mode in the nav bar', () => {
    setMobileViewport()
    ...
    expect(screen.getByText('PTC 模式')).toBeTruthy()
  })
...
describe('chaos-mobile client composition', () => {
  it('declares layout and passes its actions into the shell overlay', () => {
    expect(inject).toEqual(['slots', 'conversation', 'layout', 'workspaces'])
