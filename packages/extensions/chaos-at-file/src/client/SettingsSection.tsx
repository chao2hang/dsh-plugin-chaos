...
import type { FileIgnoreRule, FileIgnoreRuleInput } from '../types.ts'
...
export function AtFileSection({
  ...
  // Recent-workspace fallback mirroring ui-workspace's navigation rule: the
  // newest session activity wins; Host order breaks ties.
  const recentWorkspacePath = useMemo(() => {
