...
export const STYLE_ID = 'chaos-at-file-style'
...
@media (max-width: 560px) {
  /* The phone composer has less horizontal clearance and sits above mobile
     browser controls. Keep reference chips in the safe content width and make
     every touch action at least 36px high. */
  [role='listbox']:has([data-file-icon]) {
    width: min(100vw - 24px, 537px);
...
export function adoptStyles(): void {
  ...
  // whichever plugin happens to materialize after chaos-at-file.
  style.dataset.plugin = 'chaos-at-file'
