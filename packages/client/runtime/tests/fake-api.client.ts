...
export class FakeApiClient implements IApiClient {
  ...
  onUsageReport: (payload: unknown) => ReturnType<IApiClient['usageReport']['read']> = () => Promise.resolve(ok({
    days: [],
    models: [],
    unattributed: {
      requests: 0,
  ...
  readonly usageReport: IApiClient['usageReport'] = {
    read: (payload: unknown) => this.record('usage-report.read', payload, this.onUsageReport(payload)),
  }
