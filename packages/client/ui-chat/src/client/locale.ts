...
export const zh = {
  ...
  'stats.turns': '轮次',
  'stats.steps': '步骤',
  'stats.llmTotal': 'LLM 耗时',
  'stats.toolTotal': '工具耗时',
  'stats.inputTokens': '输入 Token',
  'stats.outputTokens': '输出 Token',
  'stats.cacheHitLabel': '缓存命中',
  'stats.allConversations': '全部对话',
  'stats.sessions': '会话数',
  'stats.totalTokens': '总 Token',
  'view.statistics': '统计',
  'report.nav': '使用统计',
  'report.title': '使用统计',
  'report.scope': '来自所有可读取的持久化会话；汇总覆盖完整历史。',
  'report.summary': '使用汇总',
  'report.totalTokens': '累计 Token 数',
  'report.inputTokens': '输入 Token 数',
  'report.outputTokens': '输出 Token 数',
  'report.sessions': '会话数',
  'report.turns': '对话轮次',
  'report.llmTime': 'LLM 总耗时',
  'report.toolTime': '工具总耗时',
  'report.activeDays': '活跃天数',
  'report.activity': 'Token 活动',
  'report.activityDescription': '最近 30 个日历日中有 {days} 天完成了请求；无用量日期以灰色显示。',
  'report.trend': '每日 Token 趋势图',
  'report.trendDescription': '每根堆叠柱按模型展示当天完成请求的真实 Token 用量。',
  'report.chartHint': '悬停、点击或使用键盘选择日期，查看当天详情。',
  'report.dateRange': '{start} 至 {end}',
  'report.daySummary': '{date}：{tokens}，{requests} 次请求',
  'report.selectedDay': '所选日期',
  'report.noUsage': '这一天没有完成的请求。',
  'report.updatedAt': '最近更新：{time}（前台每 30 秒刷新）',
  'report.refresh': '立即刷新',
  'report.requests': '请求数',
  'report.loading': '正在读取历史用量…',
  'report.failed': '无法读取历史用量。',
  'report.retry': '重试',
  'report.empty': '尚未记录完成请求的用量。',
  'report.models': '模型用量',
  'report.unattributed': '未归因的历史用量',
  'report.modelsUnavailable': '按模型的历史用量和成本需要服务端保存每次请求的模型归因；当前数据尚未提供。',
  'details.title': '详情',
  'details.close': '关闭详情',
...
export const en = {
  ...
  'stats.turns': 'Turns',
  'stats.steps': 'Steps',
  'stats.llmTotal': 'LLM time',
  'stats.toolTotal': 'Tool time',
  'stats.inputTokens': 'Input tokens',
  'stats.outputTokens': 'Output tokens',
  'stats.cacheHitLabel': 'Cache hit',
  'stats.allConversations': 'All conversations',
  'stats.sessions': 'Sessions',
  'stats.totalTokens': 'Total tokens',
  'view.statistics': 'Statistics',
  'report.nav': 'Usage statistics',
  'report.title': 'Usage statistics',
  'report.scope': 'All readable durable sessions; totals cover the full retained history.',
  'report.summary': 'Usage summary',
  'report.totalTokens': 'Total tokens',
  'report.inputTokens': 'Input tokens',
  'report.outputTokens': 'Output tokens',
  'report.sessions': 'Sessions',
  'report.turns': 'Conversation turns',
  'report.llmTime': 'Total LLM time',
  'report.toolTime': 'Total tool time',
  'report.activeDays': 'Active days',
  'report.activity': 'Token activity',
  'report.activityDescription': '{days} days with completed requests in the last 30 calendar days; zero-use days are gray.',
  'report.trend': 'Daily token trend',
  'report.trendDescription': 'Each stacked bar shows real completed-request token use by model for that day.',
  'report.chartHint': 'Hover, click, or use the keyboard to inspect a date.',
  'report.dateRange': '{start} to {end}',
  'report.daySummary': '{date}: {tokens}, {requests} requests',
  'report.selectedDay': 'Selected date',
  'report.noUsage': 'No completed requests on this date.',
  'report.updatedAt': 'Updated at {time} · refreshes every 30 seconds while visible',
  'report.refresh': 'Refresh now',
  'report.requests': 'Requests',
  'report.loading': 'Loading historical usage…',
  'report.failed': 'Historical usage could not be read.',
  'report.retry': 'Retry',
  'report.empty': 'No completed-request usage has been recorded yet.',
  'report.models': 'Model usage',
  'report.unattributed': 'Unattributed historical usage',
  'report.modelsUnavailable': 'Per-model history and costs require server-side attribution for every request, which the current data does not provide.',
