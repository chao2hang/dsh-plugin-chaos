              ...
              <Tooltip label={t('input.commands')} side="top" delayMs={500}>
                <button
                  ...
                  onClick={() => {
                    ...
                    if (toggleCommandMenu === undefined || inputElement === null) return
                    toggleCommandMenu({ start: inputElement.selectionStart, end: inputElement.selectionEnd })
                  }}
                >
                  /
                </button>
