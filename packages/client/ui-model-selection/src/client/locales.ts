...
export const zh = {
  ...
  'menu.model': '模型',
  'menu.effort': '推理等级',
  'menu.capabilities': '模型能力设置',
  'menu.capabilitiesHint': '上下文 · 输出 · 多模态',
  'effort.providerDefault': 'Default',
  'search.label': '搜索模型',
  'search.placeholder': '按名称、ID 或提供方筛选',
...
export const en = {
  ...
  'menu.model': 'Model',
  'menu.effort': 'Effort',
  'menu.capabilities': 'Model capabilities',
  'menu.capabilitiesHint': 'Context · output · multimodal',
  'effort.providerDefault': 'Default',
  'search.label': 'Search models',
  'search.placeholder': 'Filter by name, ID, or provider',
